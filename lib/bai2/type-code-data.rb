module Bai2
  TypeCodeData = {
    ...
    138 => [:credit, :summary, %q{Total SEPA Credits}],
    139 => [:credit, :detail,  %q{SEPA Return Credit}],
    140 => [:credit, :summary, %q{Total ACH Credits}],
    141 => [:credit, :detail,  %q{SEPA Credit Transfer}],
    142 => [:credit, :detail,  %q{ACH Credit Received}],
    143 => [:credit, :detail,  %q{Item in ACH Deposit}],
    144 => [:credit, :detail,  %q{SEPA Adjustment Credit}],
    ...
    157 => [:credit, :detail,  %q{Preauthorized Payment Credit}],
    158 => [:credit, :detail,  %q{Real Time Payment}],
    159 => [:credit, :summary, %q{Total Real Time Payment Credits}],
    160 => [:credit, :summary, %q{Total ACH Disbursing Funding Credits}],
    161 => [:credit, :detail,  %q{ACH Disbursing Funding Credit}],
    ...
    165 => [:credit, :detail,  %q{ACH Received}],
    ...
    455 => [:debit,  :detail,  %q{ACH Received}],
    458 => [:debit,  :detail,  %q{Real Time Payment}],
    459 => [:debit,  :summary, %q{Total Real Time Payment Debits}],
